# CAM4 Livestream Multi Model Recorder v.2.0.0 for Python 3.9.1 modified by @horacio9a - All credits to @beaston02 and @ahsand97
# coding: utf-8

import os, sys, time, datetime, configparser, threading, livestreamer, subprocess, queue, requests
